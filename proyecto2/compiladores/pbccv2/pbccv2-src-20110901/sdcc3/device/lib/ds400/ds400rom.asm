...
;	ds400rom.c:284: GETC                                    ; get the address of the table
...
_init_rom:
;	naked function: no prologue.
;	ds400rom.c:392: ROMCALL(ROMXT_ROM_INIT)
...
;	naked function: no prologue.
;	ds400rom.c:406: ROMREDIRECT(ROMRT_GETTIMEMILLIS)
...
_task_getthreadID:
;	naked function: no prologue.
;	ds400rom.c:420: ROMREDIRECT(ROMRT_GETTHREADID)
