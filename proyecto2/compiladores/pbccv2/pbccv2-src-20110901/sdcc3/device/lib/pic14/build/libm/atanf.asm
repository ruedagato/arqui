...
_00123_DS_
	BTFSS	STATUS,0
	GOTO	_00113_DS_
;genSkipc:3057: created from rifx:0x7ffcc72fce10
...
;	.line	74; "atanf.c"	r+=a[n];
	...
	MOVWF	r0x1015
;[ICODE] atanf.c:74: 	iTemp32 [k42 lr87:89 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float register}[r0x104E r0x104F r0x1050 r0x1051 ] = @[iTemp31 [k41 lr86:87 so:0]{ ia1 a2p0 re0 rm0 nos0 ru1 dp0}{float near* fixed}[r0x104C r0x104D ]]
	MOVF	r0x1014,W
	MOVWF	FSR
	BCF	STATUS,7
	BTFSC	r0x1015,0
...
;[ICODE] atanf.c:74: 	send iTemp32 [k42 lr87:89 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float register}[r0x104E r0x104F r0x1050 r0x1051 ]{argreg = 1}
