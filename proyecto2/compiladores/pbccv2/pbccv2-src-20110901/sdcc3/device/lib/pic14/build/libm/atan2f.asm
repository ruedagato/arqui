...
;[ICODE] atan2f.c:45: 	iTemp10 [k20 lr30:31 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char fixed}[r0x1055 ] = call ___fslt [k30 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char function    ( float fixed, float fixed)  fixed}
	...
	BANKSEL	r0x1011
	MOVWF	r0x1011
;[ICODE] atan2f.c:45: 	iTemp11 [k21 lr31:32 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x1056 ] = not iTemp10 [k20 lr30:31 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char fixed}[r0x1055 ]
	MOVF	r0x1011,W
	MOVLW	0x00
	BTFSC	STATUS,2
	MOVLW	0x01
	MOVWF	r0x1010
;[ICODE] atan2f.c:45: 	if iTemp11 [k21 lr31:32 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x1056 ] == 0 goto iTempLbl0($11)
	MOVF	r0x1010,W
	BTFSC	STATUS,2
	GOTO	_00115_DS_
