...
; This file was generated Fri Oct  2 17:08:41 2015
;--------------------------------------------------------
...
;	.line	79; "asincosf.c"	r=(b[i]+r)+b[i];
	...
	MOVWF	r0x1016
;[ICODE] asincosf.c:79: 	iTemp32 [k49 lr91:96 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ] = @[iTemp31 [k48 lr90:91 so:0]{ ia1 a2p0 re0 rm0 nos0 ru1 dp0}{const-float near* fixed}[r0x104D r0x104E ]]
	MOVF	r0x1017,W
	MOVWF	FSR
	BCF	STATUS,7
	BTFSC	r0x1016,0
	...
	MOVF	INDF,W
	MOVWF	r0x1018
;[ICODE] asincosf.c:79: 	send iTemp32 [k49 lr91:96 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ]{argreg = 1}
...
;	.line	81; "asincosf.c"	r=(a[i]-r)+a[i];
	...
	MOVWF	r0x1016
;[ICODE] asincosf.c:81: 	iTemp42 [k60 lr106:111 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ] = @[iTemp41 [k59 lr105:106 so:0]{ ia1 a2p0 re0 rm0 nos0 ru1 dp0}{const-float near* fixed}[r0x104D r0x104E ]]
	MOVF	r0x1017,W
	MOVWF	FSR
	BCF	STATUS,7
	BTFSC	r0x1016,0
	...
	MOVF	INDF,W
	MOVWF	r0x1018
;[ICODE] asincosf.c:81: 	send iTemp42 [k60 lr106:111 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ]{argreg = 1}
...
;	.line	85; "asincosf.c"	r=(a[i]+r)+a[i];
	...
	ADDLW	high (_asincosf_a_1_1 + 0)
	MOVWF	r0x1016
;[ICODE] asincosf.c:85: 	iTemp52 [k70 lr121:126 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ] = @[iTemp51 [k69 lr120:121 so:0]{ ia1 a2p0 re0 rm0 nos0 ru1 dp0}{const-float near* fixed}[r0x104D r0x104E ]]
	MOVF	r0x1017,W
	MOVWF	FSR
	BCF	STATUS,7
	BTFSC	r0x1016,0
	...
	MOVF	INDF,W
	MOVWF	r0x1018
;[ICODE] asincosf.c:85: 	send iTemp52 [k70 lr121:126 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{const-float register}[r0x104F r0x1050 r0x1051 r0x1052 ]{argreg = 1}
